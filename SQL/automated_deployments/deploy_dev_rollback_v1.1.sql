/************************************************************************************
 Filename   : deploy_dev_rollback_v1.1.sql
 Author     :
...
SELECT 'centralized_configuration_rollback_dev_v1.1_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
...
@rollback/centralized_configuration_DDL_DML_rollback_v1.1.sql
